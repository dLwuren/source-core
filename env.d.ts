// 参考文件：https://github.com/bramblex/niva/blob/main/packages/types/Niva_zh.d.ts#L72
/* eslint-disable */
/* prettier-ignore */
// @ts-nocheck
export { NivaOptions, NivaWindowOptions, NivaTrayOptions, MenuOptions }
declare global {
...
interface NivaDialog {
   ...
   */
  writeFile(filters?: string[], start_dir?: string): Promise<string | null>;
}
